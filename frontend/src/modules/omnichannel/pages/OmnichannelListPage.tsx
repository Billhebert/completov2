    ...
    <AppLayout>
      <div className="page-container">
        <div className="page-header">
          <h1 className="text-3xl font-bold text-gray-900">Omnichannel</h1>
...
export default OmnichannelListPage;
