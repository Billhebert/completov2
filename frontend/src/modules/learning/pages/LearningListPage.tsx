...
export const LearningListPage: React.FC = () => {
  ...
  const loadData = async () => {
    setIsLoading(true);
    try {
      const result = await learningService.getAll();
      setData(result.data);
    } catch (error) {
    ...
    <AppLayout>
      <div className="page-container">
        <div className="page-header">
          <h1 className="text-3xl font-bold text-gray-900">Aprendizado</h1>
