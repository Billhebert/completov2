...
import { errorHandler, notFoundHandler, apiLimiter } from "./core/middleware";
...
export async function createApp(): Promise<AppContext> {
  ...
  // evita cache em qualquer rota /api
  ...
  app.use(
    express.urlencoded({ extended: true, limit: `${env.MAX_FILE_SIZE_MB}mb` })
  );
